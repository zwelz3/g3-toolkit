 ...
 *
 * Wraps crossfilter2 for fast bitmap-indexed filtering. The
 * PropertyFilter and FilterGroup types are g3t's API; the
 * implementation delegates to crossfilter2.
 *
