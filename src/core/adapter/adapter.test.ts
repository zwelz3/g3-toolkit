...
import { ingestAlgorithmResults } from "@core/algorithm-adapter";
import { bearerAuth } from "@core/middleware";
...
// ── E2.T4: Portal right-click items ────────────────────────────────
...
describe("HolonicAdapter portal menu (M3.E2.T4)", () => {
  it("registers portal traverse menu item for holon nodes", () => {
    ...
    adapter.registerPortalMenuItems(menuManager, onTraverse);
