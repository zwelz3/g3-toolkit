...
export class HolonicAdapter implements GraphAdapter {
  ...
  constructor(private readonly dataset: HolonicDataset) {}
  ...
  /**
   * Register portal right-click items on the context menu (M3.E2.T4).
   * For each holon node, adds "Traverse portal to..." submenu items.
   */
  registerPortalMenuItems(
    ...
    const projectInterior = this.projectHolonInterior.bind(this);
